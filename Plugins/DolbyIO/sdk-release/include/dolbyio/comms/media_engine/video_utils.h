 ...
 * For now it supports to/from NV12, i420, RGB as well as helper for
 * merging/splitting UV planes.
 */
class DLB_COMMS_MEDIA_EXPORT format_converter {
 public:
   ...
   *
   * @warning Caller must ensure that height * width does not exceed buffer
   * size.
   *
   * @param src_vu Source UV Plane Buffer.
   * @param src_stride_vu Source UV Plane Stride.
   ...
   */
  static void set_plane_buffer_value(uint8_t* dst,
                                     int dst_stride,
                                     int width,
                                     int height,
                                     uint32_t value);
  ...
  /**
   * @brief Copies NV12 video format
   *
   *
   * @param src_y Source Y plane buffer.
   * @param src_stride_y Source Y plane stride.
   * @param src_uv Source UV plane buffer.
   * @param src_stride_uv Source UV plane stride.
   * @param dst_y Destination Y plane buffer.
   * @param dst_stride_y Destination Y plane stride.
   * @param dst_uv Destination UV plane buffer.
   * @param dst_stride_uv Destination UV plane stride.
   ...
   * @param height Frame height.
   */
  static int nv12_copy(const uint8_t* src_y,
                       int src_stride_y,
  ...
  /**
   * @brief Copies I420 video format
   *
   *
   * @param src_y Source Y plane buffer.
   * @param src_stride_y Source Y plane stride.
   ...
   * @retval -1 On failure.
   */
  static int i420_copy(const uint8_t* src_y,
                       int src_stride_y,
                       const uint8_t* src_u,
                       int src_stride_u,
                       const uint8_t* src_v,
  ...
  /**
   * @brief Copies ARGB video format.
   *
   * @param src_argb The pointer to the source ARGB data buffer.
   * @param src_stride_argb The stride of the source ARGB buffer.
   * @param dst_argb The pointer to the destination ARGB buffer.
   * @param dst_stride_argb The stride of the destination ARGB buffer.
   * @param width The width of the buffer.
   * @param height The height of the buffer.
   * @retval 0 On success.
   * @retval -1 On failure.
   */
  static int argb_copy(const uint8_t* src_argb,
                       int src_stride_argb,
                       uint8_t* dst_argb,
                       int dst_stride_argb,
                       int width,
