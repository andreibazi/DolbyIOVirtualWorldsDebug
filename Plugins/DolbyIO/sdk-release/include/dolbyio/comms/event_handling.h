...
class DLB_COMMS_EXPORT event_handler_connection {
 public:
   ...
   *
   * @attention  This function is asynchronous and the operation is executed on
   * the event loop of the SDK. You can either block the calling thread until
   * the operation completes or chain consecutive operations that depend on the
