...
class DLB_COMMS_EXPORT restapi_exception : public io_exception {
 public:
   ...
   */
  restapi_exception(int http_code,
                    int rest_code,
 ...
 * @ingroup exceptions
 */
class DLB_COMMS_EXPORT conference_state_exception
    : public conference_exception {
 public:
  /**
   ...
   */
  conference_state_exception(const std::string& current,
 ...
 * @ingroup exceptions
 */
class DLB_COMMS_EXPORT peer_connection_failed_exception
    : public media_engine_exception {
 public:
  /**
   * @brief The constructor that takes a reason for failure.
 ...
 * @ingroup exceptions
 */
class DLB_COMMS_EXPORT create_peer_connection_exception
    : public media_engine_exception {
 public:
  /**
 ...
 * @ingroup exceptions
 */
class DLB_COMMS_EXPORT peer_connection_disconnected_exception
    : public media_engine_exception {
 public:
  /**
   * @brief The constructor that takes the reason for error.
